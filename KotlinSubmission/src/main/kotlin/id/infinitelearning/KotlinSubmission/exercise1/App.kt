...
fun myProfile() {
        ...
        val namaDepan: String = "Fadhila"
        val namaBelakang: String = "Khairunnisa"
        val umur: Int = 21
        val status: Boolean = true
        if (status) {
            println("Nama saya " + namaDepan + " " + namaBelakang + " umur saya " + umur + " status saya " + "single")
        } else {
            println("Nama saya " + namaDepan + " " + namaBelakang + " umur saya " + umur + " status saya " + "taken")
        }
 ...
 */
fun myName(): String {
    val member = arrayOf("Fadhila", "Farizal", "Anandhito", "Hardiansyah", "Heni")
